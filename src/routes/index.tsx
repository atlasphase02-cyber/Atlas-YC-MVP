...
const TalkToYourBusiness = lazy(() =>
  import("@/components/atlas-voice.tsx").then((m) => ({ default: m.TalkToYourBusiness })),
);
const VoiceExperience = lazy(() =>
  import("@/components/atlas-voice.tsx").then((m) => ({ default: m.VoiceExperience })),
);
